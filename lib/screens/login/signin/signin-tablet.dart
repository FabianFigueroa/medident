...
class Signin_Tablet extends StatefulWidget {
  final TrackingScrollController trackingScrollController;
  const Signin_Tablet({super.key, required this.trackingScrollController});

  @override
  State<Signin_Tablet> createState() => _Signin_TabletState();
}

class _Signin_TabletState extends State<Signin_Tablet> {
  @override
  void initState() {
    super.initState();
  ...
  Widget _buildNormalLoginView(BuildContext context, SigninProvider provider) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: isKeyboardVisible
          ...
          : Padding(
              ...
              child: Column(
                ...
                children: [
                  const Text("Tabiem puedes ingresar con tus redes:"),
      ...
      body: SingleChildScrollView(
        padding: const EdgeInsets.fromLTRB(1, 65, 1, 1),
        child: Column(
          ...
          children: [
            ...
            if (provider.isLoading)
              ...
              Padding(
                padding: const EdgeInsets.fromLTRB(40, 1, 40, 1),
                child: _buildSignInButton(context, provider, 'Iniciar Sesi�n'),
              ),
